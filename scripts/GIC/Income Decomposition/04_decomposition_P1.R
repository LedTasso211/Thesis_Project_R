...
decomposition_results <- changes_wide %>%
  mutate(
    annual_change_total_income = ((adj_income_2007 / adj_income_2004)^(1/num_years) - 1)*100,
    annual_change_emp = ((income_emp_2007 / income_emp_2004)^(1/num_years) - 1)*100,
    annual_change_self_emp = ((income_self_emp_2007 / income_self_emp_2004)^(1/num_years) - 1)*100,
    annual_change_agri = ((income_agriculture_2007 / income_agriculture_2004)^(1/num_years) - 1)*100,
    annual_change_prop = ((income_property_2007 / income_property_2004)^(1/num_years) - 1)*100,
    annual_change_social = ((income_Pens_Schol_assist_2007 / income_Pens_Schol_assist_2004)^(1/num_years) - 1)*100,
    annual_change_remit = ((income_remittances_2007 / income_remittances_2004)^(1/num_years) - 1)*100,
    annual_change_gift = ((income_gift_2007 / income_gift_2004)^(1/num_years) - 1)*100,
    annual_change_non_cash = ((non_cash_icnome_2007 / non_cash_icnome_2004)^(1/num_years) - 1)*100,
    annual_change_unreported =  ((unreported_income_2007 / unreported_income_2004)^(1/num_years) - 1)*100
  ) %>%
...
decomposition_levels <- changes_wide %>%
  mutate(
    delta_total_income = adj_income_2007 - adj_income_2004,
    delta_emp          = income_emp_2007 - income_emp_2004,
    delta_self_emp     = income_self_emp_2007 - income_self_emp_2004,
    delta_agri         = income_agriculture_2007 - income_agriculture_2004,
    delta_prop         = income_property_2007 - income_property_2004,
    delta_social       = income_Pens_Schol_assist_2007 - income_Pens_Schol_assist_2004,
    delta_remit        = income_remittances_2007 - income_remittances_2004,
    delta_gift         = income_gift_2007 - income_gift_2004,
    delta_non_cash     = non_cash_icnome_2007 - non_cash_icnome_2004,
    delta_unreported   = unreported_income_2007 - unreported_income_2004
  ) %>%
...
save_results_to_excel(decomposition_results, sheet_name = "decomposition", output_file = "output/Tables/Stat_P1.xlsx")
save_results_to_excel(contribution_table_signed, sheet_name = "contribution", output_file = "output/Tables/Stat_P1.xlsx")
...
save_results_to_excel(all_glm_tests, sheet_name = "glm", output_file = "output/Tables/Stat_P1.xlsx")