...
decomposition_results <- changes_wide %>%
  mutate(
    annual_change_total_income = ((adj_income_2019 / adj_income_2013)^(1/num_years) - 1)*100,
    annual_change_emp = ((income_emp_2019 / income_emp_2013)^(1/num_years) - 1)*100,
    annual_change_self_emp = ((income_self_emp_2019 / income_self_emp_2013)^(1/num_years) - 1)*100,
    annual_change_agri = ((income_agriculture_2019 / income_agriculture_2013)^(1/num_years) - 1)*100,
    annual_change_prop = ((income_property_2019 / income_property_2013)^(1/num_years) - 1)*100,
    annual_change_social = ((income_Pens_Schol_assist_2019 / income_Pens_Schol_assist_2013)^(1/num_years) - 1)*100,
    annual_change_remit = ((income_remittances_2019 / income_remittances_2013)^(1/num_years) - 1)*100,
    annual_change_gift = ((income_gift_2019 / income_gift_2013)^(1/num_years) - 1)*100,
    annual_change_non_cash = ((non_cash_icnome_2019 / non_cash_icnome_2013)^(1/num_years) - 1)*100,
    annual_change_unreported =  ((unreported_income_2019 / unreported_income_2013)^(1/num_years) - 1)*100
  ) %>%
...
decomposition_levels <- changes_wide %>%
  mutate(
    delta_total_income = adj_income_2019 - adj_income_2013,
    delta_emp          = income_emp_2019 - income_emp_2013,
    delta_self_emp     = income_self_emp_2019 - income_self_emp_2013,
    delta_agri         = income_agriculture_2019 - income_agriculture_2013,
    delta_prop         = income_property_2019 - income_property_2013,
    delta_social       = income_Pens_Schol_assist_2019 - income_Pens_Schol_assist_2013,
    delta_remit        = income_remittances_2019 - income_remittances_2013,
    delta_gift         = income_gift_2019 - income_gift_2013,
    delta_non_cash     = non_cash_icnome_2019 - non_cash_icnome_2013,
    delta_unreported   = unreported_income_2019 - unreported_income_2013
  ) %>%
...
save_results_to_excel(decomposition_results, sheet_name = "decomposition", output_file = "output/Tables/Stat_P3.xlsx")
save_results_to_excel(contribution_table_signed, sheet_name = "contribution", output_file = "output/Tables/Stat_P3.xlsx")
...
save_results_to_excel(all_glm_tests, sheet_name = "glm", output_file = "output/Tables/Stat_P3.xlsx")