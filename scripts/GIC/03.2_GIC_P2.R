...
gic<-ggplot(gic_df, aes(x = percentile * 100, y = growth_rate)) +
  ...
  labs(
    ...
    title = "Growth Incidence Curve for Georgia (2008-2012)"
  ) +
...
ggsave(
  filename = "output/Graphs/GIC_P2.png",  
  plot     = gic,                         
  width    = 8,                           
  height   = 5,                           
  dpi      = 300                           
...
save_results_to_excel(growth_rates_df, sheet_name = "P2", output_file = "output/Tables/Growth_Rates.xlsx")