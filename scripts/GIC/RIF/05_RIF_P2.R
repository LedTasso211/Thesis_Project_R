...
save_results_to_excel(estimates_df, sheet_name = "RIF", output_file = "output/Tables/Stat_P2.xlsx")
save_results_to_excel(bootstrap_se_df, sheet_name = "RIF_bootstrap", output_file = "output/Tables/Stat_P2.xlsx")